...
import SpecificVideoItemDetails from './components/SpecificVideoItemDetails'
import SavedVideosCart from './components/SavedVideosCart'
      ...
      >
        <Switch>
          ...
          <ProtectedRoute
            exact
            path="/saved-videos"
            component={SavedVideosCart}
          />
          <ProtectedRoute
            exact
            path="/videos/:id"
            component={SpecificVideoItemDetails}
          />
